...
class TestLoadParams(unittest.TestCase):
    ...
    @patch('main.ParserFactory')
    @patch('main.FileTypesFilters')
    def test_invalid_enabled_parsers(self, mock_file_types, mock_parser_factory):
        """Test load_params with invalid ENABLED_PARSERS"""
        # Mock the available parsers
        mock_parser_factory.all_parsers_name.return_value = [
            'BAREKET', 'SHUFERSAL', 'RAMI_LEVY'
        ]
    ...
    @patch('main.ParserFactory')
    @patch('main.FileTypesFilters')
    def test_valid_enabled_file_types(self, mock_file_types, mock_parser_factory):
        """Test load_params with valid ENABLED_FILE_TYPES"""
        # Mock the available file types
        mock_file_types.all_types.return_value = [
            'PRICE_FILE', 'PROMO_FILE', 'STORE_FILE', 'PRICE_FULL_FILE', 'PROMO_FULL_FILE'
        ]
    ...
    @patch('main.ParserFactory')
    @patch('main.FileTypesFilters')
    def test_invalid_enabled_file_types(self, mock_file_types, mock_parser_factory):
        """Test load_params with invalid ENABLED_FILE_TYPES"""
        # Mock the available file types
        mock_file_types.all_types.return_value = [
            'PRICE_FILE', 'PROMO_FILE', 'STORE_FILE'
        ]
    ...
    @patch('main.ParserFactory')
    @patch('main.FileTypesFilters')
    def test_valid_number_of_processes(self, mock_file_types, mock_parser_factory):
    ...
    @patch('main.ParserFactory')
    @patch('main.FileTypesFilters')
    def test_invalid_number_of_processes(self, mock_file_types, mock_parser_factory):
        ...
        self.assertEqual(str(context.exception), "NUMBER_OF_PROCESSES must be an integer")

    @patch('main.ParserFactory')
    @patch('main.FileTypesFilters')
    def test_valid_limit(self, mock_file_types, mock_parser_factory):
    ...
    @patch('main.ParserFactory')
    @patch('main.FileTypesFilters')
    def test_invalid_limit(self, mock_file_types, mock_parser_factory):
        ...
        self.assertEqual(str(context.exception), "LIMIT must be an integer, but got not_a_number")
    ...
    @patch('main.ParserFactory')
    @patch('main.FileTypesFilters')
    def test_empty_enabled_parsers(self, mock_file_types, mock_parser_factory):
    ...
    @patch('main.ParserFactory')
    @patch('main.FileTypesFilters')
    def test_empty_enabled_file_types(self, mock_file_types, mock_parser_factory):
    ...
    @patch('main.ParserFactory')
    @patch('main.FileTypesFilters')
    def test_single_parser(self, mock_file_types, mock_parser_factory):
        ...
        expected = {
            'enabled_parsers': ['BAREKET']
        }
        self.assertEqual(result, expected)

    @patch('main.ParserFactory')
    @patch('main.FileTypesFilters')
    def test_single_file_type(self, mock_file_types, mock_parser_factory):
    ...
    @patch('main.ParserFactory')
    @patch('main.FileTypesFilters')
    def test_zero_processes(self, mock_file_types, mock_parser_factory):
    ...
    @patch('main.ParserFactory')
    @patch('main.FileTypesFilters')
    def test_zero_limit(self, mock_file_types, mock_parser_factory):
    ...
    @patch('main.ParserFactory')
    @patch('main.FileTypesFilters')
    def test_negative_number_of_processes(self, mock_file_types, mock_parser_factory):
    ...
    @patch('main.ParserFactory')
    @patch('main.FileTypesFilters')
    def test_negative_limit(self, mock_file_types, mock_parser_factory):
    ...
    @patch('main.ParserFactory')
    @patch('main.FileTypesFilters')
    def test_multiple_invalid_parsers(self, mock_file_types, mock_parser_factory):
    ...
    @patch('main.ParserFactory')
    @patch('main.FileTypesFilters')
    def test_multiple_invalid_file_types(self, mock_file_types, mock_parser_factory):
    ...
    @patch('main.ParserFactory')
    @patch('main.FileTypesFilters')
    def test_whitespace_in_enabled_parsers(self, mock_file_types, mock_parser_factory):
    ...
    @patch('main.ParserFactory')
    @patch('main.FileTypesFilters')
    def test_leading_trailing_whitespace_parsers(self, mock_file_types, mock_parser_factory):
    ...
    @patch('main.ParserFactory')
    @patch('main.FileTypesFilters')
    def test_empty_elements_in_parsers(self, mock_file_types, mock_parser_factory):
    ...
    @patch('main.ParserFactory')
    @patch('main.FileTypesFilters')
    def test_whitespace_in_enabled_file_types(self, mock_file_types, mock_parser_factory):
    ...
    @patch('main.ParserFactory')
    @patch('main.FileTypesFilters')
    def test_leading_trailing_whitespace_file_types(self, mock_file_types, mock_parser_factory):
        """Test load_params with leading/trailing whitespace in ENABLED_FILE_TYPES"""
        mock_file_types.all_types.return_value = [
            'PRICE_FILE', 'PROMO_FILE'
        ]
    ...
    @patch('main.ParserFactory')
    @patch('main.FileTypesFilters')
    def test_case_sensitivity_parsers_lowercase(self, mock_file_types, mock_parser_factory):
    ...
    @patch('main.ParserFactory')
    @patch('main.FileTypesFilters')
    def test_case_sensitivity_parsers_mixed_case(self, mock_file_types, mock_parser_factory):
    ...
    @patch('main.ParserFactory')
    @patch('main.FileTypesFilters')
    def test_case_sensitivity_file_types_lowercase(self, mock_file_types, mock_parser_factory):
    ...
    @patch('main.ParserFactory')
    @patch('main.FileTypesFilters')
    def test_case_sensitivity_file_types_mixed_case(self, mock_file_types, mock_parser_factory):
