...
class HetCohenTestCase(make_test_case(ScraperFactory.HET_COHEN, ParserFactory.HET_COHEN)):
    """
...
class FreshMarketAndSuperDoshTestCase(make_test_case(ScraperFactory.FRESH_MARKET_AND_SUPER_DOSH, ParserFactory.FRESH_MARKET_AND_SUPER_DOSH)):
    """
