...
class ParserFactory(Enum):
    ...
    COFIX = all_parsers.CofixFileConverter  # deprecated; kept for historical dumps
    CITY_MARKET_GIVATAYIM = all_parsers.CityMarketGivatayim  # deprecated; closed
    CITY_MARKET_KIRYATONO = all_parsers.CityMarketKiryatOno  # deprecated; closed
    ...
    HET_COHEN = all_parsers.HetChoenFileConverter  # deprecated; use HET_COHEN_NEW_SOURCE
    ...
    MAHSANI_ASHUK = all_parsers.MahsaniAShukPromoFileConverter  # deprecated
    MAHSANI_ASHUK_NEW_SOURCE = all_parsers.MahsaniAShukNewFileConverter
    MEGA = all_parsers.MegaFileConverter  # deprecated; merged
    ...
    QUIK = all_parsers.QuikFileConverter  # deprecated; folded into Rami Levy
    TIV_TAAM = all_parsers.TivTaamFileConverter
    VICTORY = all_parsers.VictoryFileConverter  # deprecated; use VICTORY_NEW_SOURCE
